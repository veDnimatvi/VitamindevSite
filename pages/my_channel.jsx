        ...
        <div className="mx-10 mb-20">
          ...
          <div className="sm:flex p-8 gap-10 my-10 cursor-pointer shadow-[rgba(0, 0, 0, 0.35)] shadow-xl">
            ...
            <div>
              ...
              <div className="text-sm">
                <p>
                  Được xây dựng dựa trên framework Nestjs cho backend, Nextjs và
                  Tailwindcss cho phần website khách hàng, Reactjs và Antd cho
                  phần website quản trị.
                </p>
                <p>&#10155; Phía Client</p>
                <ul className="pl-5 list-disc">
                  ...
                  <li>
                    Giỏ hàng, Mua hàng, Thanh toán online vnpay, Thanh toán COD,
                    Lịch sử mua hàng.
                  </li>
                  <li>
                ...
                <ul className="pl-5 list-disc">
                  ...
                  <li>
                    Quản lý danh mục, sản phẩm, phân loại hàng, tài khoản , đơn
                    hàng, đánh giá..
                  </li>
          ...
          <div className="sm:flex p-8 gap-10 my-10 cursor-pointer shadow-[rgba(0, 0, 0, 0.35)] shadow-xl">
            ...
            <div>
              ...
              <div className="text-sm">
                <p>
                  Được xây dựng dựa trên framework Nestjs cho backend, Angular,
                  PrimeNg, NgRx-Store cho phần website khách hàng và quản trị.
                </p>
                <p>&#10155; Phía Client</p>
                <ul className="pl-5 list-disc">
                  <li>
          ...
          <div className="sm:flex p-8 gap-10 my-10 cursor-pointer shadow-[rgba(0, 0, 0, 0.35)] shadow-xl">
            ...
            <div>
              ...
              <div className="text-sm">
                <p>
                  Được xây dựng dựa trên framework Nestjs cho backend, Nuxtjs và
                  Tailwindcss cho phần website khách hàng, Vuejs và ElementUI
